...
const OurStore = () => {
  ...
  // Determine price range from all products
  ...
  const getProducts = () => {
    // Remove price filter from the backend call
    dispatch(getAllProducts({ sort, tag, category }));
  };
        ...
        <div className="row">
          <div className="col-3">
            ...
            <div className="filter-card mb-3">
              ...
              <div>
                <h5 className="sub-title">Price</h5>
                {/* Replace the existing price inputs with the new slider component */}
                <PriceRangeSlider 
                  minPrice={minPrice} 
          ...
          <div className="col-9">
            ...
            <div className="products-list pb-5">
              <div className="d-flex gap-10 flex-wrap">
                <ProductCard
                  data={Array.isArray(productState) ? filteredProducts() : []}
                  grid={grid}
                />
              </div>
            </div>
